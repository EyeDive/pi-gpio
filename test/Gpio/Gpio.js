 ...
 */
"use strict";
const Gpio = require('../../src/Port/Gpio').Gpio,
    should = require("should"),
    fs = require("fs");

const gpioTest = function () {
    describe("Gpio", function () {
        describe("constant Command.DIRECTION_IN", function () {
            it("should be equal to 'in'", function () {
                Gpio.DIRECTION_IN.should.equal("in")
            });
        });
        describe("constant Command.DIRECTION_OUT", function () {
            it("should be equal to 'in'", function () {
